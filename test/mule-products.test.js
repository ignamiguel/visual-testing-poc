...
describe('Applitools Demo App', function() {
  it('should validate the screenshoots', function() {
    ...
    eyes.open(browser, 'ApplitoolsDemo', 'Mulesoft Products test');
    ...
    // It goes to MuleSoft Products page.
    browser.get('https://www.mulesoft.com/platform/enterprise-integration');
